...
if (dineroCofla >= 0.6 && dineroCofla < 1) {
    ...
    alert("Cofla, compra el helado de confites o 1/4 kg");
    alert("y te sobran " + (dineroCofla - 2.9));
}
else {
    alert("Cofla, lo siento, no se puede comprar");
}
...
if (dineroRoberto >= 0.6 && dineroRoberto < 1) {
    ...
    alert("Roberto, compra el helado de confites o 1/4 kg");
}
else {
    alert("Roberto, lo siento, no se puede comprar");
}
...
if (dineroPedro >= 0.6 && dineroPedro < 1) {
    ...
    alert("Pedro, compra el helado de confites o 1/4 kg");
}
else {
    alert("Pedro, lo siento, no se puede comprar");
}